...
class Config(QConfig):
    themeMode = OptionsConfigItem("Theme", "ThemeMode", Theme.AUTO, OptionsValidator(Theme),
                                  EnumSerializer(Theme))
    dpiScale = OptionsConfigItem(
        "Theme", "DpiScale", "Auto", OptionsValidator([1, 1.25, 1.5, 1.75, 2, "Auto"]), restart=True)
    themeColor = ColorConfigItem("Theme", "ThemeColor", "#009faa")
